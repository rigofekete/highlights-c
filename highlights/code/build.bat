...
cl /FC /Zi /I"C:\ffmpeg\shared\include" ..\highlights\code\recording.cpp /link user32.lib /LIBPATH:"C:\ffmpeg\shared\lib" avcodec.lib avformat.lib avdevice.lib avutil.lib swresample.lib swscale.lib
